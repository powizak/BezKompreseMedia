...
export const teamHero = {
  ...
  intro:
    'V Bezkomprese media spojujeme inovace a zkušenosti. Každý člen našeho týmu má mnoholeté zkušenosti ve svém oboru a přináší do projektů své jedinečné dovednosti a nadšení. Věříme, že spolupráce je klíčem k úspěchu, a proto pracujeme jako tým, abychom přinesli optimální výsledky na míru každému zákazníkovi.',
};

export const teamIntro =
  'Jako jednotlivci fungujeme v oboru již mnoho let a máme za sebou nespočet zakázek a technických řešení na míru pro konkrétního zákazníka.';
